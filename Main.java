...
public class Main extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Set game layout
        view = factory.inflate(R.layout.mainmenu, null);
        setContentView(view);
    ...
    public void newGame(View view1){
    	Intent intent = new Intent(Main.this, InstructionActivity.class) ;
    	intent.putExtra("PHS",200) ;
    	startActivity(intent) ;
    }
    public void instructions(View view1){
    	Intent intent = new Intent(Main.this, InstructionActivity.class) ;
    	intent.putExtra("PHS",100) ;
    	startActivity(intent) ;
    }
    @Override
